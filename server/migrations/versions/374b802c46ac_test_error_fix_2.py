...
Revision ID: 374b802c46ac
Revises: 431537b86124
Create Date: 2026-04-04 19:20:56.795968
...
revision = '374b802c46ac'
down_revision = '431537b86124'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('timestamp', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.ForeignKeyConstraint(['hostel_id'], ['hostels.id'], name=op.f('fk_announcements_hostel_id_hostels')),
